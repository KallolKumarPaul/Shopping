            ...
            foreach ($data as $value) {
              ...
              <tr>
                <td class="cart_product">
                  <a href=""><img src="<?php echo base_url()?>public/upload<?php echo $value['image']?>" alt=""></a>
                </td>
                <td class="cart_description">
                  <h4><a href=""><?php echo $value['name'] ?></a></h4>
                  <p>Product ID: <?php echo $value['id'] ?></p>
                </td>
                <td class="cart_price">
                ...
                <td class="cart_delete">
                  <a class="cart_quantity_delete" href="<?php base_url().'index.php/Shoppy/delete_item/'.$value['id']?>"><i class="fa fa-times"></i></a>
                </td>
              </tr>
              <style>
