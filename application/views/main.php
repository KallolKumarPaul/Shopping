					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="<?php echo base_url()?>index.php/Shoppingcart/registration_view"><i class="fa fa-user"></i> Account</a></li>

								<!-- <li><a href="<?php echo base_url()?>index.php/Shoppy/checkout"><i class="fa fa-crosshairs"></i> Checkout</a></li> -->
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="<?php base_url()?>index.php/Shoppingcart/login">ogin</a></li>
                                    </ul>
                                </li>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +03324703028</a></li>
